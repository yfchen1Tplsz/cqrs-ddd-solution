package com.cntaiping.adapter.output;
...
public class PolicyOutput {
    ...
    @QueryProjection
    public PolicyOutput(UUID id, String policyNo, String policyStatus, String middleMan, String channel, String policyCurrency, BigDecimal yearPremium, String paymentFrequency, String administrationType, LocalDate applicationDate, LocalDate policyEffectDate, LocalDate ensureEffectDate, LocalDate ensureExpireDate, LocalDate policyAdoptionDate, String proposalNo, String policyRemark, String policyPrp, LocalDate ndd) {
        this.id = id;
